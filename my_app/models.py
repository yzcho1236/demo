...
class Comment(models.Model):
    ...
    file = models.FileField(upload_to="img", verbose_name="文件", null=True, blank=True)
...
class BomModel(models.Model):
    ...
    annex = GenericRelation(Comment, verbose_name='附件', related_name='bom_comment', object_id_field='object_pk')
